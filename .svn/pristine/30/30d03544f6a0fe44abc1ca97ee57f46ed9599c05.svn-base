...
class Campaign extends Controller {
	...
	function campaignReport($type=''){
		...
		$links[] =($roleDetail['modules']['6']['opt_download']!=0)?$dlink.'<li><a href="campaign/campaign_csv/" class="btn-danger" data-toggle="modal" data-target="#modal-responsive"><span title="Download" class="glyphicon glyphicon-download-alt">&nbsp;DownloadAll</span></a></li>':'';
