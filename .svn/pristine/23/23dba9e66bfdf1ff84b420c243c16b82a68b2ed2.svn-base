			...
			<div class="row">					
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="form-group">
						<label class="col-sm-4 text-right"><i>Enter your number without a </br>preceding 0 or country code.</i></label>
					...
					<div class="form-group text-center">
						<input id="callme" type="submit" class="btn btn-primary clickToConnect" name="callme" value="Call" /> 
					 </div>
					<?php echo $form['close'];?>
				</div>
			</div>
