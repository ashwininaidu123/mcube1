<script type="text/javascript">
      google.charts.setOnLoadCallback(drawChart_suppop);

   function drawChart_suppop() {
	  var graphcontent = new Array();
        ...
        var chart = new google.visualization.PieChart(document.getElementById('sup_recent_callspop'));
...
<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
                <div id="sup_recent_callspop"></div>
			</div>
		</div>
	</div>
