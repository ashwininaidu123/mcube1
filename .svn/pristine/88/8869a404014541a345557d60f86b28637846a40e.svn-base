 ...
 google.charts.setOnLoadCallback(drawChartwe_pbx);
 function drawChartwe_pbx() {
 ...
 var options = {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById('pbx_groupnames'));
