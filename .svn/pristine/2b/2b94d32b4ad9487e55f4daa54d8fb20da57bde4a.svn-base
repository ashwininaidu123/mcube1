...
class Activity extends Controller {
	...
	function listactivity(){
		...
		$this->sysconfmodel->data['links'] = '<a href="activity/addactivity"><span class="glyphicon glyphicon-plus-sign" title="AddGroup"></span></a>';
  ...
  function downloadact_csv($agid,$actid){
	...
	function act_Report($agid,$actid){
		...
		$csv_link=$agid.'/'.$actid;
		$links =array();
		$links[]=($roleDetail['modules']['32']['opt_download']!=0)?'<li><a href="activity/downloadact_csv/'.$csv_link.'"  class="btn-danger" data-toggle="modal" data-target="#modal-responsive"><span title="Download" class="glyphicon glyphicon-download-alt">$nbsp;DownloadAll</span></a></li>':'';
		$formFields = array();
