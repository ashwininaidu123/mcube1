...
<!--		if($this->session->userdata('role')!=2){
				    <li>
						  <a href="" title="Sensor Id"><i class="fa fa-plus-square"></i><span class="sidebar-text">Sensor Id</span><span class="fa arrow"></span></a>
                			               <ul class="submenu collapse">
							   <li><a href="Masteradmin/addbeacon"><span class="sidebar-text">Add Sensor id</a></li>
							   <li><a href="Masteradmin/locationlist"><span class="sidebar-text">List Sensor id</a></li>
							   <li><a href="Masteradmin/assigntosite"><span class="sidebar-text">Assign To Business</a></li>
							   <li><a href="Masteradmin/Mageunasdlocation"><span class="sidebar-text">Unassigned Numbers</a></li>
							</ul>		
                                         </li>
-->            
		        <li>
					<a href="#" title="Check Email"><i class="fa fa-plus-square"></i><span class="sidebar-text"><?php echo "Business Settings"?></span><span class="fa arrow"></span></a>
				    	<ul class="submenu collapse">
							<li><a href="Masteradmin/Checkemail"><span class="sidebar-text"><?php echo "Change Email";?></span></a></li>
					</ul>
				</li>
