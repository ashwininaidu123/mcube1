<script type="text/javascript">
  google.charts.setOnLoadCallback(drawChartgrp);
  function drawChartgrp() {
 ...
 var options = {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById('priweekly'));
