...
<? }?>
	<table width="100%">
	    ...
	    <tr>
			<th><label for="businessType">Business Type: </label></th>
			<td><input name="businessType" id="businessType" type="text" size="15" class="validate[required]" value="<?php echo set_value('businessType');?>"/></td>
			<td></td>	
		</tr>
		<tr>
