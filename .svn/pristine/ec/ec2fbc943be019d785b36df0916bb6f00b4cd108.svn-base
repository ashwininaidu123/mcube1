...
<div id="main-content">
   <div class="page-title">
     ...
     <h3>
		  ...
		  <tbody>
			  <tr>
				<td class="fc-header-left">
				  <strong>MCubeX Dashboard</strong>
				</td>
									  ...
									  <div class="row">
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="300" style="min-height:300px;">
                                            ...
                                            <a href="dashboard/groupwise_pbx"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div> 
                                          <?php } ?>
                                          </div>
                                  ...
                                  <div class="panel-body bg-dark p-t-0 p-b-10">
									  <div class="row">
										<div class="col-md-12">
										  ...
										  <?php   if(!empty($pbx_groupnames)) { ?>
                                            <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/weekpopup_pbx"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div> 
                                         <?php } ?>
                                          </div>
                                 ...
                                 <div class="panel-heading text-center p-10 p-b-0">
                                   ...
                                   <div class="panel-body  bg-purple p-t-0 p-b-10">
                                      ...
                                      <?php if(!empty($pbx_callbytime)) {?> 
                                            <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbytime_pbx"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>
                                           </div>
                                           <?php } ?>
                                          </div>
										...
										<div class="col-md-12">
                                          ...
                                          <div class="withScroll" data-height="300" style="min-height:300px;">
                                           ...
                                           <div id="pbx_callbyweek"></div>
                                            ...
                                            <div class="overlay">
                                            <div class="thumbnail-actions">
                                            <a href="dashboard/callbyweek_pbx"  class="btn-danger btn btn-default btn-icon btn-rounded" data-toggle="modal" data-target="#modal-responsive" ><i class="fa fa-search"></i></a>
                                            </div>          
                                          </div> 
                                          <?php } ?>
                                          </div>
	  ...
	  <?php // echo "<pre>"; print_r($pbx_recent_calls); exit;  ?>
