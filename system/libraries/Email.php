...
class CI_Email {
	...
	//~ var	$smtp_host		= "smtpout.asia.secureserver.net";		// SMTP Server.  Example: mail.earthlink.net
	//~ var	$smtp_user		= "noreply@mcube.com";		// SMTP Username
	//~ var	$smtp_pass		= '$MetrVMC66';		// SMTP Password

	var	$protocol		= "smtp";	// mail/sendmail/smtp
	var	$smtp_host		= "ssl://smtp.googlemail.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "ashwini.naidu@vmc.in";		// SMTP Username
	var	$smtp_pass		= 'YXNoaGVtMTQz';
	...
	var	$_cc_array		= array();
	//var	$_bcc_array		= array('tapan.chatterjee@vmc.in');
	...
	function send()
	{
		...
		{
			log_message('error', 'Mail-log: '.$this->print_debugger());
			return FALSE;
		}
		else
		{
