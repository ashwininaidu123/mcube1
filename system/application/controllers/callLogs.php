...
class CallLogs extends Controller {
	...
	function callLogsList($type=''){
		...
		$data['links'] .= '<a href="#" class="blkemail" rel="campaign">&nbsp;<span title="BulkMail" class="fa fa-envelope-o"></span>&nbsp;</a>';
		$data['links'] .= '<a href="Report/blksms" class="blkSMs" data-toggle="modal" data-target="#modal-blksms" rel="campaign">&nbsp;<span title="BulkSMS" class="fa fa-comment"></span>&nbsp;</a>';
		$fieldset = $this->configmodel->getFields('35',$bid);
		$formFields = array();
