...
class partner extends controller
{
	...
	function managePriList($page='')
	{
		...
		$links =array();
		$links[] ='<li><a href="partner/addPrinumber/"><span class="glyphicon glyphicon-plus-sign" title="Add Number">AddNumber</span></a></li>';
		$formFields1 = array();
	...
	function ManageunassignedNumbers($page='')
	{
	    ...
	    $links =array();
		$links[]='<li><a href="partner/AssignMobileNumber/"><span class="glyphicon glyphicon-plus-sign" title="Add Number">AddNumber</span></a></li>';
		$formFields1 = array();
		$cf=array('label'=>'<label for="groupname">'.$this->lang->line('level_groupname').' : </label>',
				  'field'=>form_input(array(
									  'name'        => 'groupname',
