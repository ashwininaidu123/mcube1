...
class Pbx extends Controller {
	...
	function manage(){
		...
		$links = array();
		$links[] = '<li><a href="PBXadd/0"><span title="Add Mcube X" class="glyphicon glyphicon-plus-sign">&nbsp;AddMCubeX</span></a></li>';
	...
	function addext($pbxid='',$extid=''){
		...
		if(isset($itemDetail['targettype']) && $itemDetail['targettype']=='group'){
			$arr =form_dropdown('targeteid',$this->systemmodel->get_groups(),isset($itemDetail['targetid'])?$itemDetail['targetid']:'','id="targeteid" class="form-control"');
		}
		if(isset($itemDetail['targettype']) && $itemDetail['targettype']=='employee'){
			$arr =form_dropdown('targeteid',$this->systemmodel->get_emp_list(),isset($itemDetail['targetid'])?$itemDetail['targetid']:'','id="targeteid" class="form-control"');
		}
		if(isset($itemDetail['targettype']) && $itemDetail['targettype']=='pbx'){
			$arr =form_dropdown('targeteid',$this->systemmodel->get_pbx_list(),isset($itemDetail['targetid'])?$itemDetail['targetid']:'','id="targeteid" class="form-control"');
		}
		if(isset($itemDetail['targettype']) && $itemDetail['targettype']=='voicemgs'){
			$arr = '';
		}
	...
	function listext($pbxid=''){
		...
		$links= array();
		$links[] = '<li><a href="pbx/addext/'.$pbxid.'" class="btn-danger" data-toggle="modal" data-target="#modal-responsive"><span title="Add Extension" class="glyphicon glyphicon-plus-sign">&nbsp;AddExtension</span></a></li>';
		$links[] = '<li class="divider"><a>&nbsp;</a></li>';
		$links[] = '<li><a href="'.$_SERVER['REQUEST_URI'].'" class="btn-search" data-toggle="modal" data-target="#modal-search" ><span title="Search" class="glyphicon glyphicon-search" >&nbsp;Search</span></a></li>';
	...
	function report(){
		...
		if($this->input->post('graphchart')){
			$data1['module']['title'] = 'PBX Analytics';
			$data1['pbx_recent_calls'] = $this->reportmodel->pbx_recent_calls($gettimelimit='');	
			$data1['pbx_groupnames'] =$this->reportmodel->pbx_groupnames();
			$data1['pbx_callbytime'] =$this->reportmodel->pbx_callbytime($gettimelimit='');
			$data1['pbx_callbyweek'] =$this->reportmodel->pbx_callbyweek($gettimelimit='');
		    $this->sysconfmodel->viewLayout('pbxanalytics',$data1);
		   	return true;
	    }
		...
		$links[] = '<li><a href="'.$_SERVER['REQUEST_URI'].'" class="btn-search" data-toggle="modal" data-target="#modal-search" ><span title="Search" class="glyphicon glyphicon-search" >&nbsp;Search</span></a></li>';
		$links[] = '<li  class="divider"><a>&nbsp;</a></li>';
		$links[]= ($roleDetail['modules']['24']['opt_download'])?'<li><a href="pbx/pbx_csv" class="btn-danger" data-toggle="modal" data-target="#modal-responsive"><span title="Download" class="glyphicon glyphicon-download-alt">&nbsp;DownloadAll</span></a></li>':'';
		$ofset = ($this->uri->segment(3)!=null)?$this->uri->segment(3):0;
		$limit = '30';
