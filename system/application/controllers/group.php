...
class Group extends Controller {
	...
	function Undelte_emplist($id){
		...
		$formFields=array();
		$formFields[] = array(
					'label'=>'<label class="col-sm-4 text-right" for="eid">Landing Number: </label>',
	...
	function add_groupfrm($id='',$clone=''){
		...
		foreach($fieldset as $field){
			...
			if($supChk == 0) {
				//$inArr = array('supportgrp','replytocust_missed','replytocust_attended','replytocust_repcal');
				$inArr = array('replytocust_missed','replytocust_attended','replytocust_repcal');
			}
				...
				foreach($roleDetail['system'] as $ret){if($ret['fieldid']==$field['fieldid'])$checked = true;}
					...
					if($checked){
						...
						$cf = array('label'=>(($field['fieldname']=='leadaction' ) ? (($leadaccess == 1) ? ('<label class="col-sm-4 text-right" for="'.$field['fieldname'].'">'.(($field['customlabel']!="")
									...
									'field'=>((in_array($field['fieldname'],array('connectowner','sameexe','recordnotice','misscall','pincode','allgroup','mailalerttowoner')))?
									form_checkbox(array('class'=>"switch",'data-size'=>"mini",
											  ...
											  'name'      => $field['fieldname']
											  ,'id'        => $field['fieldname']
											  ,'class'	  => 'form-control valid word_count'
											...
											form_dropdown('eid',$this->groupmodel->employee_list(),
														 (isset($itemDetail['epid']) && $itemDetail['epid']!="") ? $itemDetail['epid'] : $this->input->post('eid')
											...
											:(($field['fieldname'] == "rules")?
												...
												:(($field['fieldname'] == "primary_rule")?
													form_dropdown('primary_rule',$this->groupmodel->PrimaryRuleList(),(isset($itemDetail['primary_rule'])?$itemDetail['primary_rule']:$this->input->post('primary_rule')),"id='primary_rule'  class='form-control required' data-style='input-sm btn-default'")
														...
														form_dropdown('prinumber',$this->systemmodel->getPriList(isset($itemDetail['prinumber'])?$itemDetail['prinumber']:'','1'),(isset($itemDetail['prinumber']) && $itemDetail['prinumber']>20000)?$itemDetail['prinumber']:(($id!="")?'0':''),"id='prinumber' class='form-control required' data-style='input-sm btn-default'")
															:(($field['fieldname']=='bday')?
																'<table class="short"><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Mon][day]','value'=>'1','id'=>'mon_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Mon->day) || $id=='')?true:''))).'<label class="text-right" for="mon_day">Monday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Tue][day]','value'=>'1','id'=>'tue_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Tue->day) || $id=='')?true:''))).'<label class="text-right" for="tue_day">Tuesday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Wed][day]','value'=>'1','id'=>'wed_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Wed->day) || $id=='')?true:''))).'<label class="text-right" for="wed_day">Wednesday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Thu][day]','value'=>'1','id'=>'thu_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Thu->day) || $id=='')?true:''))).'<label class="text-right" for="thu_day">Thursday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Fri][day]','value'=>'1','id'=>'fri_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Fri->day) || $id=='')?true:''))).'<label class="text-right" for="fri_day">Friday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Sat][day]','value'=>'1','id'=>'sat_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Sat->day) || $id=='')?true:''))).'<label class="text-right" for="sat_day">Saturday</label>'.'</td>'
																...
																.'</tr><tr>'
																.'<td>'.form_checkbox(array('name'=>'bday[Sun][day]','value'=>'1','id'=>'sun_day','class'=>"switch",'data-size'=>"mini",'checked'=>((isset($bday->Sun->day) || $id=='')?true:''))).'<label class="text-right" for="sun_day">Sunday</label>'.'</td>'
											                 ...
											                 .((isset($itemDetail[$field['fieldname']]) && $itemDetail[$field['fieldname']]!='' && file_exists('sounds/'.$itemDetail[$field['fieldname']]))? 
																	...
																	(form_input(array(
																	  ...
																	  ,'id'        => 'voicmess'
																      ,'style' => 'float: left'
																     ,'checked'=>(isset($itemDetail['custom_voice_file']) && $itemDetail['custom_voice_file']=='1')? TRUE: FALSE
																	 ))	)
																	.(form_input(array(
																	  'name'      => $field['fieldname']
																	  ,'id'        => $field['fieldname']
																      ,'type' => 'file'
																      ,'style' => 'float: left; display :none;margin-bottom:10px;'
																      ,'value'     => isset($itemDetail[$field['fieldname']])?$itemDetail[$field['fieldname']]:$this->input->post($field['fieldname'])
																	 ))	).((isset($itemDetail[$field['fieldname']]) && $itemDetail[$field['fieldname']]!='' && file_exists('sounds/'.$itemDetail[$field['fieldname']]))? 
										                              	...
										                              	.'&nbsp <a href="'.base_url().'Employee/delvoicemessage/'.$itemDetail['gid'].'">
										                              	 <span id="delvoice" title="Delete Audio file" class="glyphicon glyphicon-trash"></span></a>':'')
										                              	.'</div></div><div class="form-group "><label id ="lavelcls" style= display:none  class="col-sm-4 text-right" for="voicemessage">Text to read out as Voice &nbsp;&nbsp;<img src="system/application/img/icons/help.png" title="Voice Message"> </label><div class="col-sm-6 input-icon right">'
										                              .(form_textarea(array(
																	  'name'      => 'voicemessagetext'
																	  ,'placeholder' => "Type text to read out"
																	  ,'id'        => 'voicemessagetext'
																      ,'class'     => "form-control"
																      ,'value'     =>isset($itemDetail['voicemessagetext'])?$itemDetail['voicemessagetext']:$this->input->post('voicemessagetext')
																	 ))	) 					 			 				 
                                                                     :((in_array($field['fieldname'],array('record','replytocustomer','replytoexecutive')))? 
																	form_checkbox(array('class'=>"switch",'data-size'=>"mini",
																                         'id'=>$field['fieldname']
																                         ,'name'=>$field['fieldname']
															                             ,'checked'=>isset($itemDetail[$field['fieldname']])?$itemDetail[$field['fieldname']]:'checked'
																                         ,'value'=>'1'))	
																	:((in_array($field['fieldname'],array('keyword','keyword1','keyword2','hdaytext','supportaction')))? 
																	(form_input(array(
																	  'class'     => "form-control"
																	  ,'name'      => $field['fieldname']
																	  ,'id'        => $field['fieldname']
																   ...
																   //~ :((in_array($field['fieldname'],array("replytocust_voice")))?
																		//~ form_checkbox(array('class'=>"switch",'data-size'=>"mini",
																                         //~ 'id'=>$field['fieldname']
																                         //~ ,'name'=>$field['fieldname']
															                             //~ ,'checked'=>isset($itemDetail[$field['fieldname']])?$itemDetail[$field['fieldname']]:''
																                         //~ ,'value'=>'0')).'<a  class="btn-danger" data-toggle="modal" data-target="#modal-responsive" href="'.base_url().'Employee/add_voicemessage" ></a>'		
																	  :(form_input(array(
	...
	function getPri($val =''){
		...
		$result = $this->groupmodel->getPri($val,$mod);
	...
	function manage_group($bid=''){
		...
		$data['itemlist'] = $this->configmodel->strip_slashes_recursive($data['itemlist']);
		...
		$link = array();
		$links[] = ($roleDetail['modules']['6']['opt_delete']) ?'<li><a  class="blkDeletecall" href="group/groupBulkDelete" ><span title="Bulk Delete" class="glyphicon glyphicon-trash">&nbsp;Delete</span></a></li>':'';
		$links[] = '<li><a href="AddGroup"><span title="Add Group" class="glyphicon glyphicon-plus-sign">&nbsp;AddGroup</span></a></li>';
		...
		foreach($fieldset as $field){
			...
			if($field['type']=='s' && $field['show'] && !in_array($field['fieldname'],
						array(  'keyword','landingregion'
			,"primary_rule","record","bday","hdaytext","replymessage","replytocustomer","replytoexecutive","replytoexecutive","timeout"
			,"oneditaction","onhangup","replyattmsg","leadaction","oncallaction","supportaction","supportgrp","landingregion",
			"replytocust_missed","replytocust_attended","replytocust_repcal",'filename','bday','url','connectowner','hdayaudio','greetings','sameexe','recordnotice','misscall','pincode','allgroup','access_reports','voicemessage','replytocust_voitext'
								))){
				foreach($roleDetail['system'] as $ret){if($ret['fieldid']==$field['fieldid'])$checked = true;}
				if($checked){ $formFields[] = array(
	...
	function groupBulkDelete(){

		$this->groupmodel->bulkDelete($_POST['callid']);
	}
	...
	function deletedgroup($num=''){
		...
		foreach($fieldset as $field){
			$checked = false;
			if($field['type']=='s' && $field['show'] && !in_array($field['fieldname'],array('keyword','addnumber','landingregion'
			,"primary_rule","record","bday","hdaytext","replymessage","replytocustomer","replytoexecutive","replytoexecutive","timeout"
			,"oneditaction","onhangup","replyattmsg","leadaction","oncallaction","supportaction","supportgrp","landingregion",
			"replytocust_missed","replytocust_attended","replytocust_repcal",'filename','bday','url','connectowner','hdayaudio','greetings','sameexe','recordnotice','misscall','pincode','allgroup','access_reports','voicemessage','replytocust_voitext'))){
				foreach($roleDetail['system'] as $ret){if($ret['fieldid']==$field['fieldid'])$checked = true;}
	...
	function group_emp_list($gid){
		...
		if(count($emp_list['data'])>0){
			...
			foreach ($emp_list['data'] as $item){
				...
				$opt.=($opt_add)?$s:'';	 
				$rec[] = '<a href="Employee/activerecords/'.$item['eid'].'" class="btn-danger" data-toggle="modal" data-target="#modal-responsive">'.(($item['status']=="1" && $item['estatus']=='1') ? $item['empname'] : '<font color=red>'.$item['empname'].'</font>').'</a>';
				$rec[] = ($item['status']=="1" && $item['estatus']=='1') ? $item['groupname'] : '<font color=red>'.$item['groupname'].'</font>';
				if($gpDetail['primary_rule']>0) 
					$rec[]=(($item['status']=="1" && $item['estatus']=='1') ? $item['region'] : '<font color=red>'.$item['region'].'</font>');	
				if($gpDetail['rule']=='2') 
					$rec[]=($item['status']=="1" && $item['estatus']=='1') ? $item['empweight'] : '<font color=red>'.$item['empweight'].'</font>';
				if($gpDetail['rule']=='3') 
					$rec[]=($item['status']=="1" && $item['estatus']=='1') ? $item['empPriority'] : '<font color=red>'.$item['empPriority'].'</font>';
				$rec[] = ($item['status']=="1" && $item['estatus']=='1') ? $item['starttime'] : '<font color=red>'.$item['starttime'].'</font>';
				$rec[] = ($item['status']=="1" && $item['estatus']=='1') ? $item['endtime'] : '<font color=red>'.$item['endtime'].'</font>';
				$rec[] = ($item['status']=="1" && $item['estatus']=='1') ? $item['failover'] : '<font color=red>'.$item['failover'].'</font>';
				$rec[] = ($item['status']=="1" && $item['estatus']=='1') ? $item['callcounter'] : '<font color=red>'.$item['callcounter'].'</font>';
				$rec['action'] = $opt;
				$i++;
				array_push($list,$rec);
			 }
		...
		$links = array();
		$links[] ='<li><a href="AddempGroup/'.$gid.'"><span title="Add Number" class="glyphicon glyphicon-plus-sign">&nbsp;AddEmployee</span></a></li>';
		$links[] = '<li><a href="group/refreshcounter/'.$gid.'"> <span title="Reset Counter" class="fa fa-refresh">&nbsp;ResetCounter</span></a></li>';
		$links[] = '<li class="divider"><a>&nbsp;</a></li>';
		$links[] = '<li><a href="'.$_SERVER['REQUEST_URI'].'" class="btn-search" data-toggle="modal" data-target="#modal-search" ><span title="Search" class="glyphicon glyphicon-search" >&nbsp;Search</span></a></li>';
		$formFields = array();
	...
	function blocklist(){
		...
		foreach ($credit_info['data'] as $item){
				($item['status']=="0")
				?$s='<a href="'.base_url().'group/blocknumber_status/'.$item['id'].'"><span class="fa fa-unlock" id="'.$item['id'].'" title="Call Allowed"></span></a>'
				:$s='<a href="'.base_url().'group/blocknumber_status/'.$item['id'].'"> <span class="fa fa-lock" id="'.$item['id'].'" title="Number Blocked"></span></a>';
			$rec[] = array(
					$item['id'],
					$item['number'],
					$item['reason'],
		...
		$links = array();
		$links[]='<li><a href="Blocknumbers"><span title="Add Black list number" class="glyphicon glyphicon-plus-sign">&nbsp;AddNumber</span></a></li>';
		$links[] = '<li class="divider"><a>&nbsp;</a></li>';
		$links[] = '<li><a href="'.$_SERVER['REQUEST_URI'].'" class="btn-search" data-toggle="modal" data-target="#modal-search" ><span title="Search" class="glyphicon glyphicon-search" >&nbsp;Search</span></a></li>';
	    $formFields1 = array();
	...
	function configList(){
		...
		$this->sysconfmodel->data['links'] = '<a href="poll/addpoll"><span title="Add Number" class="glyphicon glyphicon-plus-sign">&nbsp;AddNumber</span></a>';
		$formFields = array();
	...
	function hlist(){
		...
		$links = array();
		$links[]='<li><a href="AddHoliday"><span title="Add Holiday" class="glyphicon glyphicon-plus-sign">&nbsp;AddHoliday</span></a></li>';
		$links[] = '<li class="divider"><a>&nbsp;</a></li>';
		$links[] = '<li><a href="'.$_SERVER['REQUEST_URI'].'" class="btn-search" data-toggle="modal" data-target="#modal-search" ><span title="Search" class="glyphicon glyphicon-search" >&nbsp;Search</span></a></li>';
		...
		foreach ($emp_list['data'] as $item){
			...
			if($opt_add || $opt_view || $opt_delete){
				...
				$act .= ($opt_add)? '<li><a href="EditHoliday/'.$item['id'].'"><span title="Edit" class="glyphicon glyphicon-edit">&nbsp;Edit</span></a></li>':'';
				$act .= ($opt_delete) ? '<li><a href="group/deleteHoliday/'.$item['id'].'"><span title="Delete" class="glyphicon glyphicon-trash">&nbsp;Delete</span></a></li>':'';
				$act .= '</ul></div>';
			}
			$arrs['action'] = $act;
			foreach($keys as $k){
	...
	function business_packages($pir){
	    $cbid=$this->session->userdata('cbid');
		$bid=(isset($cbid) && $cbid!="")?$cbid:$this->session->userdata('bid');
		$bpackage=$this->groupmodel->get_bpackages($bid,$pir);
	    if(in_array($bpackage,'8')){
			print_r("found"); exit;
		return false;
	    }else{
