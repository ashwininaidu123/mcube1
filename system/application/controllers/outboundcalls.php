...
class outboundcalls extends controller
{
	...
	function obc_grpemp_list($ogid){
		...
		$links = array();
		$links[] = '<li><a href="outboundcalls/addgrpemp/'.$this->uri->segment(3).'"><span class="glyphicon glyphicon-plus-sign" title="Add Employee to Outboundcall Group">AddGroup</span></a></li>';
		$formFields = array();
	...
	function obc_grp_list($type='')
	{
		...
		$links= array();	
		$links[] = '<li><a href="outboundcalls/obc_grp_add/"><span class="glyphicon glyphicon-plus-sign" title="Add Group">$nbsp; AddGroup</span></a></li>';
		$fieldset = $this->configmodel->getFields('44',$bid);
									...
									'field'=>
										($field['fieldname']=='eid')?form_dropdown('eid',$this->outboundcallsmodel->employee_list(),'',"class='form-control'")
											...
											:form_input(array(
												'name'      => $field['fieldname'],
												'id'        => $field['fieldname'],
												'class'		=>($field['fieldname']=="createdon" || $field['fieldname']=="lastmodified")?'datepicker form-control':'form-control'
												))
									));
							}		
			}elseif($field['type']=='c' && $field['show']){
	...
	function listcontacts()
	{
		...
		$links =array();
		$links[]=($roleDetail['modules']['45']['opt_download']!=0)?'<li><a href="Report/ContactsCsv/"  class="blkSMs" data-toggle="modal" data-target="#modal-blksms"><span title="Download" class="glyphicon glyphicon-download-alt">$nbsp;DownloadAll</span></a></li>':'';
