			...
			<div class="panel panel-default">
				...
				<?php if(!isset($nobulk)){?>
					...
					<span style="float:right;font-size:13px;">
                            ...
                            <span title="Clear Search" class="glyphicon glyphicon-search" style='color:#FFF;'></span><input class="claersearch" style='color:#FFF;font-weight:bold;background: none;font-size:15px;border: none;' type="submit" name="submit" value="Clearsearch">
                            </form>
                         </span>
                        </div>
                 <?php } ?>
				...
				<div class="panel-body">
					<div class="row">
					 ...
					 <div class="col-md-4">	
							...
							<i title="List View of Report" class="fa fa-list iconcss"></i>
							<i  title="Graphical Representation of Report" class="fa fa-bar-chart-o iconcss"></i>
