		...
		<div class="modal-body">
			...
			<table width="100%" id='FromTab1' class="table table-striped table-hover">
				<?php
				 ...
				 }elseif($fiedls[0]['fieldtype'] == 'text' && $fiedls[0]['custType'] == '1'  ){
				 ?>
				 <tr>
					<th><label class="col-sm-6 text-right" ><?php echo "Custom Field Type";?> : </label></th>
					<td><input type="text" name="custTypeVal" id="custTypeVal" class="form-control required" value="<?php echo (isset($fiedls[0]['custTypeVal']))?$fiedls[0]['custTypeVal']:'';?>"/></td>
					<td><div id="err1" style="color:red"></div></td>
				</tr>
				 <?php } ?>
			</table>
