            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-form">
                        ...
                        <!-- END ERROR BOX -->
                        <form id="form" name="login" method="POST" action="<?=site_url('Masteradmin/index/')?>" class="icon-validation">
							<div class="maindiv"> 
								<div class="innerdiv">
...
-->
									...
									<div style="width:100%;margin:0 auto;float:left; margin-top:-15px;">
										<input id="button1" type="submit" name="submit"  class="btn btn-login" value="Login" />
									</div>
								</div>
							</div>
                        </form>
