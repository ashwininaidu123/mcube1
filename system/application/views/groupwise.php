<script type="text/javascript">
      google.charts.setOnLoadCallback(drawChartgrpwise);
   function drawChartgrpwise () {
	  var graphcontent = new Array();
        ...
        var chart = new google.visualization.PieChart(document.getElementById('Recent_callsgrp'));
