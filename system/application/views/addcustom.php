		...
		<div class="modal-body">
			...
			<label   class="col-sm-4 text-right"><?php echo $this->lang->line('level_labelname');?> : </label>
			 <div class="col-sm-6 input-icon right" >          
				...
				<div class="form-group">
					<label  class="col-sm-4 text-right"><?php echo 'Value Update';?> : </label>
					<div class="col-sm-6 input-icon right" >          
						<?php echo form_checkbox(array('name'=>'valueupdate','id'=>'valueupdate'),'1');?>
					</div>
				</div>	
				<?php if($str == '6' || $str == '16' || $str == '24'){ ?>
				<div class="form-group">
					<label  class="col-sm-4 text-right"><?php echo $this->lang->line('level_custType');?> : </label>
					<div class="col-sm-6 input-icon right" >          
						<?php echo form_checkbox(array('name'=>'custType','id'=>'custType'),'1');?>
						<input type="text" name="custTypeval" id="custTypeval" class="form-control" placeholder="custom field  Auto value" style="width:200px;" /><br/>
						Note: If it is enabled, the field will be non editable in reports with auto update values.	
						<div id="err1" style="color:red;"></div>
					</div>
				</div>	
				<?php } ?>
